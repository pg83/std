...
namespace {
    struct TestNode: public HashTable2::Node {
        int value;
    };
}

STD_TEST_SUITE(HashTable2) {
    ...
    STD_TEST(VisitEmptyTable) {
        ...
        int count = 0;
        ht.visit([&count](HashTable2::Node* node) {
            count++;
        });
    ...
    STD_TEST(VisitSingleElement) {
        ...
        int count = 0;
        HashTable2::Node* lastNode = nullptr;
        ht.visit([&count, &lastNode](HashTable2::Node* n) {
            count++;
            lastNode = n;
        });
    ...
    STD_TEST(VisitAllElements) {
        ...
        int sum = 0;
        ht.visit([&sum](HashTable2::Node* node) {
